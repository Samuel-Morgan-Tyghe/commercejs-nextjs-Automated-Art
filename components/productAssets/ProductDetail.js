    ...
    return (
      <div>
        ...
        {/* <p className="font-size-display3 font-family-secondary mt-2 mb-2">
          {this.props.product.image.filename.replace(".webp", "")}
        </p> */}
        {/* <div className="mb-4 pb-3 font-size-subheader">
          {this.props.product.image.filename.replace(".webp", "")} was created using an automated
          system , using photoshop, scripts and data mining for inspiration of the best textures ,
          colors and shapes.
        </div> */}
