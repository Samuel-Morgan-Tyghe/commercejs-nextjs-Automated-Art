...
const detailView = `<p>
  A Unique Piece of Artwork, generated from scripts and autonomous techniques. 
</p>`;
...
export default function Product() {
  ...
  console.log("🚀 ~ file: [permalink].js ~ line 66 ~ Product ~ images", images);
  console.log(product);
  return (
    <Root>
      <Head>
        <title>{product.image.filename.replace(".webp", "")} | Automated Art</title>
      </Head>
          ...
          <div className="product-detail">
            ...
            <Collapse isOpened={showShipping}>
              <div className="pb-4 font-color-medium">
                Arrives instantly, <a href="mailto:samuelmorganvisual@gmail.com">Contact</a> me if
